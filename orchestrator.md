...
| 頻度 | タスク |
|------|--------|
| 毎セッション | 記事1本以上を書くか、既存記事を改善する |
| 5セッションごと | キーワード調査で新しいターゲットを発見する |
| 10セッションごと | 全体戦略レビュー + ベイズ更新 |
| 30セッションごと | 新しい収益チャネルの調査 |
...
1. **パターン認識**: 書いた記事の中で、検索に強かったパターンを memory.json に記録
2. **ベイズ更新**: 「このニッチは伸びる」「この記事形式が効く」等の仮説を beliefs.json で追跡
3. **バンディット調整**: 成果の良いテーマに配分を増やし、悪いテーマを減らす
4. **新規開拓**: 定期的に新しいニッチ・収益モデルを調査し、有望なら試す
5. **リライト**: 既存記事のパフォーマンスを定期チェックし、改善の余地があればリライト
